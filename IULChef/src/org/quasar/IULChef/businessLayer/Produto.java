...
public abstract class Produto implements Comparable<Object> {
	 ...
	 * 
	 * @param restaurantes
	 *            the restaurantes to initialize
	 * @param nome
	 *            the nome to initialize
	 * @param precoVenda
	 *            the precoVenda to initialize
	 * @param quantidade
	 *            the quantidade to initialize
	 * @param tipo
	 *            the tipo to initialize
	 * @param unidade
	 *            the unidade to initialize
	 **********************************************************************/
	public Produto(Set<Restaurante> restaurantes, String nome,
			Double precoVenda, Integer quantidade, TipoProduto tipo,
			Unidade unidade) {
	 ...
	 *            the quantidade to set
	 **********************************************************************/
	public void init(String nome, TipoProduto tipo, Unidade unidade,
			Double precoVenda, Integer quantidade) {
		// self.nome := nome; self.tipo := tipo; self.unidade := unidade;
		// self.precoVenda := precoVenda; self.quantidade := quantidade
		this.nome = nome;
		this.tipo = tipo;
		this.unidade = unidade;
		this.precoVenda = precoVenda;
	...
	public void checkUnidadeDeveSerPreenchida() {
		...
		boolean invariant = unidade != null;
	...
	public void checkPrecoDeveSerPreenchido() {
		...
		boolean invariant = precoVenda != null;
	...
	/**********************************************************************
	 * @param other
	 *            Produto to compare to the current one
	 * @return 0 if the argument is equal to the current Produto; a value less
	 *         than 0 if the argument is greater than the current Produto; and a
	 *         value greater than 0 if the argument is less than this Produto.
	 **********************************************************************/
	@Override
	...
	/**********************************************************************
	 * @param other
	 *            Produto to check equality to the current one
	 * @return true if the argument is equal to the current Produto and false
	 *         otherwise
	 **********************************************************************/
	@Override
	public boolean equals(Object other) {
		...
		if ((this.nome == null) ? (another.nome != null) : !this.nome
				.equals(another.nome))
			return false;
		if ((this.precoVenda == null) ? (another.precoVenda != null)
				: !this.precoVenda.equals(another.precoVenda))
			return false;
		if ((this.quantidade == null) ? (another.quantidade != null)
				: !this.quantidade.equals(another.quantidade))
			return false;
		if ((this.tipo == null) ? (another.tipo != null) : !this.tipo
				.equals(another.tipo))
			return false;
		if ((this.unidade == null) ? (another.unidade != null) : !this.unidade
				.equals(another.unidade))
			return false;
	...
	public String toString() {
		return "Produto[nome=" + nome() + ", precoVenda=" + precoVenda()
				+ ", quantidade=" + quantidade() + ", tipo=" + tipo()
				+ ", unidade=" + unidade() + ", composicao("
				+ composicao().size() + "), confecionados("
				+ confecionados().size() + "), pedidos(" + pedidos().size()
				+ "), restaurantes(" + restaurantes().size() + ")]";
	}
