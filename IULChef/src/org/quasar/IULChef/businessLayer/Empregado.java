...
public class Empregado extends Entidade implements Comparable<Object>
{
	...
	public void ContrataEmpregado(Restaurante r, Empregado e)
	{
		...
		//	-----------------------------------------------------------------------------
		//	declare cd : CalendarDate, c : Contrato; cd := new CalendarDate; c := new Contrato between (r,e);
		//		cd.initS('2014-06-25'); c.inicio := cd; cd.initS('2015-06-25'); c.fim := cd; c.vencimento := 800
		...
		//		so faco isto para ter a certeza
		c.setContratados(e);
		c.setEmpregadores(r);
		//	-----------------------------------------------------------------------------
