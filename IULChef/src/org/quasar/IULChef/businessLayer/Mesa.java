...
public class Mesa implements Comparable<Object> {
	...
	/**********************************************************************
	 * @param other
	 *            Mesa to compare to the current one
	 * @return 0 if the argument is equal to the current Mesa; a value less than
	 *         0 if the argument is greater than the current Mesa; and a value
	 *         greater than 0 if the argument is less than this Mesa.
	 **********************************************************************/
	@Override
	...
	/**********************************************************************
	 * @param other
	 *            Mesa to check equality to the current one
	 * @return true if the argument is equal to the current Mesa and false
	 *         otherwise
	 **********************************************************************/
	@Override
	...
	public String toString() {
		return "Mesa[numero=" + numero() + ", faturas(" + faturas().size()
				+ "), restaurante(" + (restaurante() == null ? "0" : "1")
				+ ")]";
	}
