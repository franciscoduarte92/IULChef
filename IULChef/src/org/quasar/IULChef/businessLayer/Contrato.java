...
public class Contrato implements Comparable<Object> {
	 ...
	 * 
	 * @param empregadores
	 *            the empregadores to initialize
	 * @param contratados
	 *            the contratados to initialize
	 **********************************************************************/
	 ...
	 *            the contratados to initialize
	 * @param fim
	 *            the fim to initialize
	 * @param inicio
	 *            the inicio to initialize
	 * @param vencimento
	 *            the vencimento to initialize
	 **********************************************************************/
	public Contrato(Restaurante empregadores, Empregado contratados,
			CalendarDate fim, CalendarDate inicio, Double vencimento) {
		assert empregadores != null;
		assert contratados != null;
	...
	/**********************************************************************
	 * @param other
	 *            Contrato to compare to the current one
	 * @return 0 if the argument is equal to the current Contrato; a value less
	 *         than 0 if the argument is greater than the current Contrato; and
	...
	/**********************************************************************
	 * @param other
	 *            Contrato to check equality to the current one
	 * @return true if the argument is equal to the current Contrato and false
	 *         otherwise
	 **********************************************************************/
	@Override
	public boolean equals(Object other) {
		...
		if (!super.equals(another))
			return false;
		if ((this.fim == null) ? (another.fim != null) : !this.fim
				.equals(another.fim))
			return false;
		if ((this.inicio == null) ? (another.inicio != null) : !this.inicio
				.equals(another.inicio))
			return false;
		if ((this.vencimento == null) ? (another.vencimento != null)
				: !this.vencimento.equals(another.vencimento))
			return false;
	...
	public String toString() {
		return "Contrato[fim=" + fim() + ", inicio=" + inicio()
				+ ", vencimento=" + vencimento() + ", contratados("
				+ (contratados() == null ? "0" : "1") + "), empregadores("
				+ (empregadores() == null ? "0" : "1") + ")]";
	}
