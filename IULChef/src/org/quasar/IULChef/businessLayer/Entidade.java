...
public abstract class Entidade implements Comparable<Object> {
	 ...
	 * 
	 * @param morada
	 *            the morada to initialize
	 * @param nc
	 *            the nc to initialize
	 * @param nome
	...
	public void checkNCcomNoveDigitos() {
		// Entidade.allInstances->sortedBy($elem6 : Entidade |
		// $elem6.nc)->forAll($elem7 : Entidade |
		// (($elem7.oclAsType(Entidade).nc > 0) and
		// ($elem7.oclAsType(Entidade).nc < 999999999)))
		boolean invariant = nc.toString().length() == 9;
	...
	/**********************************************************************
	 * @param other
	 *            Entidade to compare to the current one
	 * @return 0 if the argument is equal to the current Entidade; a value less
	 *         than 0 if the argument is greater than the current Entidade; and
	...
	/**********************************************************************
	 * @param other
	 *            Entidade to check equality to the current one
	 * @return true if the argument is equal to the current Entidade and false
	 *         otherwise
	 **********************************************************************/
	@Override
	public boolean equals(Object other) {
		...
		if ((this.morada == null) ? (another.morada != null) : !this.morada
				.equals(another.morada))
			return false;
		if ((this.nc == null) ? (another.nc != null) : !this.nc
				.equals(another.nc))
			return false;
	...
	public String toString() {
		return "Entidade[morada=" + morada() + ", nc=" + nc() + ", nome="
				+ nome() + "]";
	}
