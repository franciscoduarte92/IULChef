...
public class Pedido implements Comparable<Object> {
	 ...
	 * 
	 * @param produto
	 *            the produto to initialize
	 * @param fatura
	 *            the fatura to initialize
	 * @param devolvido
	 *            the devolvido to initialize
	 * @param quantidade
	 *            the quantidade to initialize
	 **********************************************************************/
	public Pedido(Produto produto, Fatura fatura, Boolean devolvido,
			Integer quantidade) {
		assert produto != null;
		assert fatura != null;
	...
	/**********************************************************************
	 * @param other
	 *            Pedido to compare to the current one
	 * @return 0 if the argument is equal to the current Pedido; a value less
	 *         than 0 if the argument is greater than the current Pedido; and a
	 *         value greater than 0 if the argument is less than this Pedido.
	 **********************************************************************/
	@Override
	...
	/**********************************************************************
	 * @param other
	 *            Pedido to check equality to the current one
	 * @return true if the argument is equal to the current Pedido and false
	 *         otherwise
	 **********************************************************************/
	@Override
	public boolean equals(Object other) {
		...
		if (!super.equals(another))
			return false;
		if ((this.devolvido == null) ? (another.devolvido != null)
				: !this.devolvido.equals(another.devolvido))
			return false;
	...
	public String toString() {
		return "Pedido[devolvido=" + devolvido() + ", quantidade="
				+ quantidade() + ", fatura(" + (fatura() == null ? "0" : "1")
				+ "), produto(" + (produto() == null ? "0" : "1") + ")]";
	}
