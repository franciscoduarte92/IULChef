...
public class Restaurante extends Entidade implements Comparable<Object>
{
	...
	* @param inventario the inventario to add
	**********************************************************************/
	...
	* @param inventario the inventario to remove
	**********************************************************************/
	...
	**********************************************************************/
	...
	/**********************************************************************
	* MANY2MANY single setter for Restaurante[*] <-> Produto[*]
	* @param produto the produto to remove
	**********************************************************************/
	...
	**********************************************************************/
	...
	public void checkRestauranteTemPeloMenosUmEmpregado()
	{
		...
		//	(Restaurante.allInstances->collect($e : Restaurante | $e.contratados)->collect($elem11 : Empregado | $elem11.contrato)->size > 1)
	...
	{
		//	TODO conclude the implementation of this OCL invariant:
		//	(Restaurante.allInstances->collect($e : Restaurante | $e.compras)->collect($elem10 : Compra | $elem10.fornecedor)->size > 1)
		boolean invariant = true;
	...
	/**********************************************************************
	* @param other Restaurante to compare to the current one
	* @return 0 if the argument is equal to the current Restaurante;
	* a value less than 0 if the argument is greater than the current Restaurante;
	* and a value greater than 0 if the argument is less than this Restaurante.
	**********************************************************************/
	@Override
	...
	/**********************************************************************
	* @param other Restaurante to check equality to the current one
	* @return true if the argument is equal to the current Restaurante and false otherwise
	**********************************************************************/
	@Override
	...
	**********************************************************************/
	...
	{
		return "Restaurante[morada="+morada() + ", nc="+nc() + ", nome="+nome() + ", compras(" + compras().size() + "), contratados(" + contratados().size() + "), contrato(" + contrato().size() + "), faturas(" + faturas().size() + "), inventarios(" + inventarios().size() + "), mesas(" + mesas().size() + "), produtos(" + produtos().size() + ")]";
	}
